 ...
 * @generated
 */
public class Variant_handlingSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Variant_handlingPackage.VARIANT_ENTITY: {
				VariantEntity variantEntity = (VariantEntity)theEObject;
				T result = caseVariantEntity(variantEntity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Variant_handlingPackage.VARIATION: {
				Variation variation = (Variation)theEObject;
				T result = caseVariation(variation);
				if (result == null) result = caseEASTADLNamedElement(variation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Variant_handlingPackage.SELECTION: {
				Selection selection = (Selection)theEObject;
				T result = caseSelection(selection);
				if (result == null) result = caseEASTADLNamedElement(selection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Variant_handlingPackage.EXCLUSION: {
				Exclusion exclusion = (Exclusion)theEObject;
				T result = caseExclusion(exclusion);
				if (result == null) result = caseEASTADLNamedElement(exclusion);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
