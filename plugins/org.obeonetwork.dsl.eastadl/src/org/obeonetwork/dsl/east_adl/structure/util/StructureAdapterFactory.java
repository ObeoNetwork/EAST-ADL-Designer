 ...
 * $Id$
 */
package org.obeonetwork.dsl.east_adl.structure.util;
...
import org.obeonetwork.dsl.east_adl.structure.*;
...
public class StructureAdapterFactory extends AdapterFactoryImpl {
	...
	protected StructureSwitch<Adapter> modelSwitch =
		new StructureSwitch<Adapter>() {
			@Override
			public Adapter caseStructureHolder(StructureHolder object) {
				return createStructureHolderAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.obeonetwork.dsl.east_adl.structure.StructureHolder <em>Holder</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createStructureHolderAdapter() {
		return null;
	}
