...
public class StructureSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case StructurePackage.STRUCTURE_HOLDER: {
				StructureHolder structureHolder = (StructureHolder)theEObject;
				T result = caseStructureHolder(structureHolder);
	 ...
	 * @generated
	 */
	public T caseStructureHolder(StructureHolder object) {
		return null;
	}
