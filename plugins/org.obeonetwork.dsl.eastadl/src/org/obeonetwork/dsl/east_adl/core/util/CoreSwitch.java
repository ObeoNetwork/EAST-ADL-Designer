 ...
 * $Id$
 */
package org.obeonetwork.dsl.east_adl.core.util;
...
import org.obeonetwork.dsl.east_adl.core.*;
 ...
 * <!-- end-user-doc -->
 * @see org.obeonetwork.dsl.east_adl.core.CorePackage
 * @generated
 */
public class CoreSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CorePackage.EASTADL_NAMED_ELEMENT: {
				EASTADLNamedElement eastadlNamedElement = (EASTADLNamedElement)theEObject;
				T result = caseEASTADLNamedElement(eastadlNamedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CorePackage.EASTADL_ARTIFACT: {
				EASTADLArtifact eastadlArtifact = (EASTADLArtifact)theEObject;
				T result = caseEASTADLArtifact(eastadlArtifact);
				if (result == null) result = caseEASTADLNamedElement(eastadlArtifact);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CorePackage.EASTADL_ENTITY: {
				EASTADLEntity eastadlEntity = (EASTADLEntity)theEObject;
				T result = caseEASTADLEntity(eastadlEntity);
				if (result == null) result = caseEASTADLNamedElement(eastadlEntity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
