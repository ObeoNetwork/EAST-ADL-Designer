...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.east_adl.support.ArchivedEntity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArchivedEntityItemProvider
	 ...
	 * @generated
	 */
	public ArchivedEntityItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((ArchivedEntity)object).getArchiveDescription();
		return label == null || label.length() == 0 ?
			getString("_UI_ArchivedEntity_type") :
			getString("_UI_ArchivedEntity_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ArchivedEntity.class)) {
