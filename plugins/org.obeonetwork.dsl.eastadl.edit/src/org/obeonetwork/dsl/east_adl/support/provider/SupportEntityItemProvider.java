...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.east_adl.support.SupportEntity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SupportEntityItemProvider
	 ...
	 * @generated
	 */
	public SupportEntityItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((SupportEntity)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SupportEntity_type") :
			getString("_UI_SupportEntity_type") + " " + label;
	}
