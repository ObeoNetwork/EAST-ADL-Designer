...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.east_adl.verification_validation.Input} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Input_actualResult_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Input_actualResult_feature", "_UI_Input_type"),
				 Verification_validationPackage.Literals.INPUT__ACTUAL_RESULT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Verification_validationPackage.Literals.INPUT__OUTPUT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addScenarioPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Input_scenario_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Input_scenario_feature", "_UI_Input_type"),
				 Verification_validationPackage.Literals.INPUT__SCENARIO,
				 true,
				 false,
				 false,
