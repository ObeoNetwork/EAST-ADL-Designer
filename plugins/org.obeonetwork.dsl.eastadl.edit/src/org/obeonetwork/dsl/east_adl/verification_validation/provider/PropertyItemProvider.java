...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.east_adl.verification_validation.Property} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Property_formalism_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Property_formalism_feature", "_UI_Property_type"),
				 Verification_validationPackage.Literals.PROPERTY__FORMALISM,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Verification_validationPackage.Literals.PROPERTY__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
