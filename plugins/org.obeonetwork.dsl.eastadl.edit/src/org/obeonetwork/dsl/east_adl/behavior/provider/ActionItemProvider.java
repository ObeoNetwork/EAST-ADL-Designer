...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.east_adl.behavior.Action} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Action_transition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Action_transition_feature", "_UI_Action_type"),
				 BehaviorPackage.Literals.ACTION__TRANSITION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDirectivePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Action_directive_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Action_directive_feature", "_UI_Action_type"),
				 BehaviorPackage.Literals.ACTION__DIRECTIVE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Action)object).getDirective();
