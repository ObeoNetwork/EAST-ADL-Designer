...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.east_adl.structure.functional_design_architecture.CompositeSoftwareFunction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeSoftwareFunctionItemProvider
	 ...
	 * @generated
	 */
	public CompositeSoftwareFunctionItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Functional_design_architecturePackage.Literals.COMPOSITE_SOFTWARE_FUNCTION__ELEMENTARY_SOFTWARE_FUNCTIONS);
			childrenFeatures.add(Functional_design_architecturePackage.Literals.COMPOSITE_SOFTWARE_FUNCTION__COMPOSITE_SOFTWARE_FUNCTIONS);
			childrenFeatures.add(Functional_design_architecturePackage.Literals.COMPOSITE_SOFTWARE_FUNCTION__PORTS);
			childrenFeatures.add(Functional_design_architecturePackage.Literals.COMPOSITE_SOFTWARE_FUNCTION__PARAMETERS);
		}
	...
	/**
	 * This returns CompositeSoftwareFunction.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CompositeSoftwareFunction"));
	}
	...
	public String getText(Object object) {
		String label = ((CompositeSoftwareFunction)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CompositeSoftwareFunction_type") :
			getString("_UI_CompositeSoftwareFunction_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CompositeSoftwareFunction.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Functional_design_architecturePackage.Literals.COMPOSITE_SOFTWARE_FUNCTION__ELEMENTARY_SOFTWARE_FUNCTIONS,
		...
		newChildDescriptors.add
			(createChildParameter
				(Functional_design_architecturePackage.Literals.COMPOSITE_SOFTWARE_FUNCTION__COMPOSITE_SOFTWARE_FUNCTIONS,
		...
		newChildDescriptors.add
			(createChildParameter
				(Functional_design_architecturePackage.Literals.COMPOSITE_SOFTWARE_FUNCTION__PORTS,
		...
		newChildDescriptors.add
			(createChildParameter
				(Functional_design_architecturePackage.Literals.COMPOSITE_SOFTWARE_FUNCTION__PARAMETERS,
