...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.east_adl.structure.common.ServiceParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceParameter_modifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceParameter_modifier_feature", "_UI_ServiceParameter_type"),
				 CommonPackage.Literals.SERVICE_PARAMETER__MODIFIER,
				 true,
				 false,
				 false,
	...
	protected void addDataTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceParameter_dataType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceParameter_dataType_feature", "_UI_ServiceParameter_type"),
				 CommonPackage.Literals.SERVICE_PARAMETER__DATA_TYPE,
				 true,
				 false,
				 true,
				 null,
