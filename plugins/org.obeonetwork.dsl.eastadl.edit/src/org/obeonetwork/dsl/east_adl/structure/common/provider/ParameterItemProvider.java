...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.east_adl.structure.common.Parameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parameter_constant_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parameter_constant_feature", "_UI_Parameter_type"),
				 CommonPackage.Literals.PARAMETER__CONSTANT,
				 true,
				 false,
				 false,
	...
	protected void addOwnerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parameter_owner_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parameter_owner_feature", "_UI_Parameter_type"),
				 CommonPackage.Literals.PARAMETER__OWNER,
				 false,
				 false,
				 false,
				 null,
	...
	protected void addInstancesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parameter_instances_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parameter_instances_feature", "_UI_Parameter_type"),
				 CommonPackage.Literals.PARAMETER__INSTANCES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CommonPackage.Literals.PARAMETER__DATA_TYPE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CommonPackage.Literals.PARAMETER__DIRECTION,
				 true,
				 false,
				 false,
