...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.east_adl.structure.hardware_architecture.Wire} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Hardware_architecturePackage.Literals.WIRE__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDestinationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Wire_destination_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Wire_destination_feature", "_UI_Wire_type"),
				 Hardware_architecturePackage.Literals.WIRE__DESTINATION,
				 true,
				 false,
				 true,
				 null,
