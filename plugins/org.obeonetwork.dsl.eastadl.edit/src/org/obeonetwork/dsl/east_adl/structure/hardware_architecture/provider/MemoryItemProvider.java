...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.east_adl.structure.hardware_architecture.Memory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MemoryItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addUsingProcessorsPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Memory_memoryType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Memory_memoryType_feature", "_UI_Memory_type"),
				 Hardware_architecturePackage.Literals.MEMORY__MEMORY_TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Hardware_architecturePackage.Literals.MEMORY__SIZE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Using Processors feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addUsingProcessorsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Memory_usingProcessors_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Memory_usingProcessors_feature", "_UI_Memory_type"),
				 Hardware_architecturePackage.Literals.MEMORY__USING_PROCESSORS,
				 true,
				 false,
				 true,
				 null,
