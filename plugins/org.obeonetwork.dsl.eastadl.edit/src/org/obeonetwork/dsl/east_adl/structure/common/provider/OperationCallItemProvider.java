...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.east_adl.structure.common.OperationCall} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationCallItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addEmitterPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OperationCall_receiver_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OperationCall_receiver_feature", "_UI_OperationCall_type"),
				 CommonPackage.Literals.OPERATION_CALL__RECEIVER,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Emitter feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addEmitterPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OperationCall_emitter_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OperationCall_emitter_feature", "_UI_OperationCall_type"),
				 CommonPackage.Literals.OPERATION_CALL__EMITTER,
				 true,
				 false,
				 true,
				 null,
