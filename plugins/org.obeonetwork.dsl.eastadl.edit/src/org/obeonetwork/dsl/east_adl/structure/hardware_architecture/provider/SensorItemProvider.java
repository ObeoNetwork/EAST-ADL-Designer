...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.east_adl.structure.hardware_architecture.Sensor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SensorItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSensorModelPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Hardware_architecturePackage.Literals.SENSOR__QUANTITY,
				 true,
				 false,
				 false,
	...
	protected void addChannelsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sensor_channels_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sensor_channels_feature", "_UI_Sensor_type"),
				 Hardware_architecturePackage.Literals.SENSOR__CHANNELS,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Sensor Model feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSensorModelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sensor_sensorModel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sensor_sensorModel_feature", "_UI_Sensor_type"),
				 Hardware_architecturePackage.Literals.SENSOR__SENSOR_MODEL,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Hardware_architecturePackage.Literals.SENSOR__PINS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Hardware_architecturePackage.Literals.SENSOR__PINS,
